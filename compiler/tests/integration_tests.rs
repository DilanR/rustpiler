...
mod expr {
    ...
    fn arithmetic_expr_with_if_nested() {
        test_expr!(if false { 1 } else { if true { 2 } else { 3 } });
        test_expr!(if true { 1 } else { if true { 2 } else { 3 } });
        test_expr!(if true { 1 } else { if false { 2 } else { 3 } });
        test_expr!(if false { 1 } else { if true { 2 } else { 3 } });
        test_expr!(if false { 1 } else { if false { 2 } else { 3 } });
        test_expr!(if true {
            1
        } else if true {
            2
    ...
    fn crazy() {
        test_expr!(
            if false { 1 } else { if false { 2 } else { 3 } } * 2
                + if true {
                    1
                } else if true {
                    2
...
mod ref_deref {
    #![allow(clippy::all)]
    use compiler::test_expr;
    use compiler::{ast::Block, test_block};
